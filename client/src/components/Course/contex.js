...
fetchUserData(){
  ...
  fetch("https://graphite-sphere-286919.uc.r.appspot.com/getuser").then(response => response.json())
...
fetchProductData(){
  fetch("https://graphite-sphere-286919.uc.r.appspot.com/getproduct").then(response => response.json())
